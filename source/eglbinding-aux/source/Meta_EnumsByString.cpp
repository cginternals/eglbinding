...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_B =
{
    ...
    { "EGL_BOTTOM_NV", EGLenum::EGL_BOTTOM_NV },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_C =
{
    ...
    { "EGL_COLOR_COMPONENT_TYPE_INTEGER_ARM", EGLenum::EGL_COLOR_COMPONENT_TYPE_INTEGER_ARM },
    { "EGL_COLOR_COMPONENT_TYPE_UNSIGNED_INTEGER_ARM", EGLenum::EGL_COLOR_COMPONENT_TYPE_UNSIGNED_INTEGER_ARM },
    ...
    { "EGL_CONFIG_SELECT_GROUP_EXT", EGLenum::EGL_CONFIG_SELECT_GROUP_EXT },
    ...
    { "EGL_CONSUMER_AUTO_ORIENTATION_NV", EGLenum::EGL_CONSUMER_AUTO_ORIENTATION_NV },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_D =
{
    ...
    { "EGL_DEVICE_UUID_EXT", EGLenum::EGL_DEVICE_UUID_EXT },
    ...
    { "EGL_DRIVER_NAME_EXT", EGLenum::EGL_DRIVER_NAME_EXT },
    { "EGL_DRIVER_UUID_EXT", EGLenum::EGL_DRIVER_UUID_EXT },
    ...
    { "EGL_DRM_RENDER_NODE_FILE_EXT", EGLenum::EGL_DRM_RENDER_NODE_FILE_EXT }
};
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_G =
{
    ...
    { "EGL_GL_COLORSPACE_BT2020_HLG_EXT", EGLenum::EGL_GL_COLORSPACE_BT2020_HLG_EXT },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_L =
{
    ...
    { "EGL_LEFT_NV", EGLenum::EGL_LEFT_NV },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_N =
{
    ...
    { "EGL_NATIVE_BUFFER_QNX", EGLenum::EGL_NATIVE_BUFFER_QNX },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_O =
{
    ...
    { "EGL_OPENWF_DEVICE_EXT", EGLenum::EGL_OPENWF_DEVICE_EXT },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_P =
{
    ...
    { "EGL_PLATFORM_SCREEN_QNX", EGLenum::EGL_PLATFORM_SCREEN_QNX },
    ...
    { "EGL_PLATFORM_XCB_EXT", EGLenum::EGL_PLATFORM_XCB_EXT },
    { "EGL_PLATFORM_XCB_SCREEN_EXT", EGLenum::EGL_PLATFORM_XCB_SCREEN_EXT },
    { "EGL_POST_SUB_BUFFER_SUPPORTED_NV", EGLenum::EGL_POST_SUB_BUFFER_SUPPORTED_NV },
    { "EGL_PRESENT_OPAQUE_EXT", EGLenum::EGL_PRESENT_OPAQUE_EXT },
    { "EGL_PRIMARY_COMPOSITOR_CONTEXT_EXT", EGLenum::EGL_PRIMARY_COMPOSITOR_CONTEXT_EXT },
    { "EGL_PRODUCER_AUTO_ORIENTATION_NV", EGLenum::EGL_PRODUCER_AUTO_ORIENTATION_NV },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_R =
{
    ...
    { "EGL_RENDERER_EXT", EGLenum::EGL_RENDERER_EXT },
    { "EGL_RGB_BUFFER", EGLenum::EGL_RGB_BUFFER },
    { "EGL_RIGHT_NV", EGLenum::EGL_RIGHT_NV }
};
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_S =
{
    ...
    { "EGL_STREAM_CONSUMER_IMAGE_NV", EGLenum::EGL_STREAM_CONSUMER_IMAGE_NV },
    { "EGL_STREAM_CONSUMER_IMAGE_USE_SCANOUT_NV", EGLenum::EGL_STREAM_CONSUMER_IMAGE_USE_SCANOUT_NV },
    ...
    { "EGL_STREAM_DMA_NV", EGLenum::EGL_STREAM_DMA_NV },
    { "EGL_STREAM_DMA_SERVER_NV", EGLenum::EGL_STREAM_DMA_SERVER_NV },
    ...
    { "EGL_STREAM_FRAME_MAJOR_AXIS_NV", EGLenum::EGL_STREAM_FRAME_MAJOR_AXIS_NV },
    { "EGL_STREAM_FRAME_ORIGIN_X_NV", EGLenum::EGL_STREAM_FRAME_ORIGIN_X_NV },
    { "EGL_STREAM_FRAME_ORIGIN_Y_NV", EGLenum::EGL_STREAM_FRAME_ORIGIN_Y_NV },
    { "EGL_STREAM_IMAGE_ADD_NV", EGLenum::EGL_STREAM_IMAGE_ADD_NV },
    { "EGL_STREAM_IMAGE_AVAILABLE_NV", EGLenum::EGL_STREAM_IMAGE_AVAILABLE_NV },
    { "EGL_STREAM_IMAGE_REMOVE_NV", EGLenum::EGL_STREAM_IMAGE_REMOVE_NV },
    ...
    { "EGL_SURFACE_COMPRESSION_EXT", EGLenum::EGL_SURFACE_COMPRESSION_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_10BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_10BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_11BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_11BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_12BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_12BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_1BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_1BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_2BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_2BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_3BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_3BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_4BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_4BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_5BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_5BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_6BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_6BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_7BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_7BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_8BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_8BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_9BPC_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_9BPC_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_DEFAULT_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_DEFAULT_EXT },
    { "EGL_SURFACE_COMPRESSION_FIXED_RATE_NONE_EXT", EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_NONE_EXT },
    { "EGL_SURFACE_COMPRESSION_PLANE1_EXT", EGLenum::EGL_SURFACE_COMPRESSION_PLANE1_EXT },
    { "EGL_SURFACE_COMPRESSION_PLANE2_EXT", EGLenum::EGL_SURFACE_COMPRESSION_PLANE2_EXT },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_T =
{
    ...
    { "EGL_TEXTURE_EXTERNAL_WL", EGLenum::EGL_TEXTURE_EXTERNAL_WL },
    ...
    { "EGL_TEXTURE_Y_U_V_WL", EGLenum::EGL_TEXTURE_Y_U_V_WL },
    { "EGL_TEXTURE_Y_UV_WL", EGLenum::EGL_TEXTURE_Y_UV_WL },
    { "EGL_TEXTURE_Y_XUXV_WL", EGLenum::EGL_TEXTURE_Y_XUXV_WL },
...
{
    { "EGL_WAYLAND_BUFFER_WL", EGLenum::EGL_WAYLAND_BUFFER_WL },
    { "EGL_WAYLAND_PLANE_WL", EGLenum::EGL_WAYLAND_PLANE_WL },
    { "EGL_WAYLAND_Y_INVERTED_WL", EGLenum::EGL_WAYLAND_Y_INVERTED_WL },
    { "EGL_WIDTH", EGLenum::EGL_WIDTH }
};

const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_X =
{
    { "EGL_X_AXIS_NV", EGLenum::EGL_X_AXIS_NV }
};

const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_Y =
{
    { "EGL_Y_AXIS_NV", EGLenum::EGL_Y_AXIS_NV },
