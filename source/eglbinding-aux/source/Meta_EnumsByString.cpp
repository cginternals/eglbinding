...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_C =
{
    ...
    { "EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT", EGLenum::EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT },
    { "EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR", EGLenum::EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR },
    { "EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT", EGLenum::EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT },
    { "EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT_KHR", EGLenum::EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT_KHR },
    { "EGL_CONTEXT_OPENGL_DEBUG", EGLenum::EGL_CONTEXT_OPENGL_DEBUG },
    { "EGL_CONTEXT_OPENGL_DEBUG_BIT_KHR", EGLenum::EGL_CONTEXT_OPENGL_DEBUG_BIT_KHR },
    { "EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE", EGLenum::EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE },
    { "EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT_KHR", EGLenum::EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT_KHR },
    ...
    { "EGL_CONTEXT_OPENGL_ROBUST_ACCESS_BIT_KHR", EGLenum::EGL_CONTEXT_OPENGL_ROBUST_ACCESS_BIT_KHR },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_D =
{
    ...
    { "EGL_DRM_BUFFER_USE_CURSOR_MESA", EGLenum::EGL_DRM_BUFFER_USE_CURSOR_MESA },
    { "EGL_DRM_BUFFER_USE_MESA", EGLenum::EGL_DRM_BUFFER_USE_MESA },
    { "EGL_DRM_BUFFER_USE_SCANOUT_MESA", EGLenum::EGL_DRM_BUFFER_USE_SCANOUT_MESA },
    { "EGL_DRM_BUFFER_USE_SHARE_MESA", EGLenum::EGL_DRM_BUFFER_USE_SHARE_MESA },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_L =
{
    ...
    { "EGL_LOCK_SURFACE_BIT_KHR", EGLenum::EGL_LOCK_SURFACE_BIT_KHR },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_M =
{
    ...
    { "EGL_MULTISAMPLE_RESOLVE_BOX_BIT", EGLenum::EGL_MULTISAMPLE_RESOLVE_BOX_BIT },
    ...
    { "EGL_MUTABLE_RENDER_BUFFER_BIT_KHR", EGLenum::EGL_MUTABLE_RENDER_BUFFER_BIT_KHR }
};
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_N =
{
    ...
    { "EGL_NONE_BIT", EGLenum::EGL_NONE_BIT },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_O =
{
    ...
    { "EGL_OPENGL_BIT", EGLenum::EGL_OPENGL_BIT },
    { "EGL_OPENGL_ES2_BIT", EGLenum::EGL_OPENGL_ES2_BIT },
    { "EGL_OPENGL_ES3_BIT", EGLenum::EGL_OPENGL_ES3_BIT },
    { "EGL_OPENGL_ES3_BIT_KHR", EGLenum::EGL_OPENGL_ES3_BIT_KHR },
    { "EGL_OPENGL_ES_API", EGLenum::EGL_OPENGL_ES_API },
    { "EGL_OPENGL_ES_BIT", EGLenum::EGL_OPENGL_ES_BIT },
    { "EGL_OPENVG_API", EGLenum::EGL_OPENVG_API },
    { "EGL_OPENVG_BIT", EGLenum::EGL_OPENVG_BIT },
    ...
    { "EGL_OPTIMAL_FORMAT_BIT_KHR", EGLenum::EGL_OPTIMAL_FORMAT_BIT_KHR }
};

const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_P =
{
    { "EGL_PBUFFER_BIT", EGLenum::EGL_PBUFFER_BIT },
    ...
    { "EGL_PIXMAP_BIT", EGLenum::EGL_PIXMAP_BIT },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_R =
{
    ...
    { "EGL_READ_SURFACE_BIT_KHR", EGLenum::EGL_READ_SURFACE_BIT_KHR },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_S =
{
    ...
    { "EGL_STREAM_BIT_KHR", EGLenum::EGL_STREAM_BIT_KHR },
    ...
    { "EGL_SWAP_BEHAVIOR_PRESERVED_BIT", EGLenum::EGL_SWAP_BEHAVIOR_PRESERVED_BIT },
    ...
    { "EGL_SYNC_FLUSH_COMMANDS_BIT", EGLenum::EGL_SYNC_FLUSH_COMMANDS_BIT },
    { "EGL_SYNC_FLUSH_COMMANDS_BIT_KHR", EGLenum::EGL_SYNC_FLUSH_COMMANDS_BIT_KHR },
    { "EGL_SYNC_FLUSH_COMMANDS_BIT_NV", EGLenum::EGL_SYNC_FLUSH_COMMANDS_BIT_NV },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_V =
{
    ...
    { "EGL_VG_ALPHA_FORMAT_PRE_BIT", EGLenum::EGL_VG_ALPHA_FORMAT_PRE_BIT },
    { "EGL_VG_ALPHA_FORMAT_PRE_BIT_KHR", EGLenum::EGL_VG_ALPHA_FORMAT_PRE_BIT_KHR },
    { "EGL_VG_COLORSPACE", EGLenum::EGL_VG_COLORSPACE },
    { "EGL_VG_COLORSPACE_LINEAR", EGLenum::EGL_VG_COLORSPACE_LINEAR },
    { "EGL_VG_COLORSPACE_LINEAR_BIT", EGLenum::EGL_VG_COLORSPACE_LINEAR_BIT },
    { "EGL_VG_COLORSPACE_LINEAR_BIT_KHR", EGLenum::EGL_VG_COLORSPACE_LINEAR_BIT_KHR },
...
const std::unordered_map<std::string, EGLenum> Meta_EnumsByString_W =
{
    ...
    { "EGL_WINDOW_BIT", EGLenum::EGL_WINDOW_BIT },
    { "EGL_WRITE_SURFACE_BIT_KHR", EGLenum::EGL_WRITE_SURFACE_BIT_KHR }
};
