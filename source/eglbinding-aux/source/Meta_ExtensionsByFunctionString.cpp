...
const std::unordered_map<std::string, std::set<EGLextension>> Meta_ExtensionsByFunctionString_G =
{
    ...
    { "eglGetMscRateANGLE", { EGLextension::EGL_ANGLE_sync_control_rate } },
...
const std::unordered_map<std::string, std::set<EGLextension>> Meta_ExtensionsByFunctionString_Q =
{
    ...
    { "eglQueryDeviceBinaryEXT", { EGLextension::EGL_EXT_device_persistent_id } },
    ...
    { "eglQueryStreamConsumerEventNV", { EGLextension::EGL_NV_stream_consumer_eglimage } },
    ...
    { "eglQuerySupportedCompressionRatesEXT", { EGLextension::EGL_EXT_surface_compression } },
...
const std::unordered_map<std::string, std::set<EGLextension>> Meta_ExtensionsByFunctionString_S =
{
    ...
    { "eglStreamAcquireImageNV", { EGLextension::EGL_NV_stream_consumer_eglimage } },
    ...
    { "eglStreamImageConsumerConnectNV", { EGLextension::EGL_NV_stream_consumer_eglimage } },
    { "eglStreamReleaseImageNV", { EGLextension::EGL_NV_stream_consumer_eglimage } },
