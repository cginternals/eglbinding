...
const std::unordered_map<EGLextension, std::set<std::string>> Meta_FunctionStringsByExtension =
{
    ...
    { EGLextension::EGL_ANGLE_sync_control_rate, { "eglGetMscRateANGLE" } },
    ...
    { EGLextension::EGL_EXT_device_persistent_id, { "eglQueryDeviceBinaryEXT" } },
    ...
    { EGLextension::EGL_EXT_surface_compression, { "eglQuerySupportedCompressionRatesEXT" } },
    { EGLextension::EGL_EXT_swap_buffers_with_damage, { "eglSwapBuffersWithDamageEXT" } },
    { EGLextension::EGL_EXT_sync_reuse, { "eglUnsignalSyncEXT" } },
    ...
    { EGLextension::EGL_MESA_query_driver, { "eglGetDisplayDriverConfig", "eglGetDisplayDriverName" } },
    ...
    { EGLextension::EGL_NV_stream_consumer_eglimage, { "eglQueryStreamConsumerEventNV", "eglStreamAcquireImageNV", "eglStreamImageConsumerConnectNV", "eglStreamReleaseImageNV" } },
    { EGLextension::EGL_NV_stream_consumer_gltexture_yuv, { "eglStreamConsumerGLTextureExternalAttribsNV" } },
    { EGLextension::EGL_NV_stream_flush, { "eglStreamFlushNV" } },
