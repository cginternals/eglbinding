...
const std::multimap<EGLenum, std::string> Meta_StringsByEnum =
{
    ...
    { EGLenum::EGL_BOTTOM_NV, "EGL_BOTTOM_NV" },
    { EGLenum::EGL_BUFFER_AGE_EXT, "EGL_BUFFER_AGE_EXT" },
    { EGLenum::EGL_BUFFER_AGE_KHR, "EGL_BUFFER_AGE_KHR" },
    ...
    { EGLenum::EGL_CL_EVENT_HANDLE_KHR, "EGL_CL_EVENT_HANDLE_KHR" },
    ...
    { EGLenum::EGL_COLOR_COMPONENT_TYPE_INTEGER_ARM, "EGL_COLOR_COMPONENT_TYPE_INTEGER_ARM" },
    { EGLenum::EGL_COLOR_COMPONENT_TYPE_UNSIGNED_INTEGER_ARM, "EGL_COLOR_COMPONENT_TYPE_UNSIGNED_INTEGER_ARM" },
    ...
    { EGLenum::EGL_CONDITION_SATISFIED_KHR, "EGL_CONDITION_SATISFIED_KHR" },
    ...
    { EGLenum::EGL_CONFIG_SELECT_GROUP_EXT, "EGL_CONFIG_SELECT_GROUP_EXT" },
    { EGLenum::EGL_CONFORMANT, "EGL_CONFORMANT" },
    { EGLenum::EGL_CONFORMANT_KHR, "EGL_CONFORMANT_KHR" },
    { EGLenum::EGL_CONSUMER_ACQUIRE_TIMEOUT_USEC_KHR, "EGL_CONSUMER_ACQUIRE_TIMEOUT_USEC_KHR" },
    { EGLenum::EGL_CONSUMER_AUTO_ORIENTATION_NV, "EGL_CONSUMER_AUTO_ORIENTATION_NV" },
    ...
    { EGLenum::EGL_CONTEXT_MAJOR_VERSION, "EGL_CONTEXT_MAJOR_VERSION" },
    { EGLenum::EGL_CONTEXT_MAJOR_VERSION_KHR, "EGL_CONTEXT_MAJOR_VERSION_KHR" },
    { EGLenum::EGL_CONTEXT_MINOR_VERSION, "EGL_CONTEXT_MINOR_VERSION" },
    { EGLenum::EGL_CONTEXT_MINOR_VERSION_KHR, "EGL_CONTEXT_MINOR_VERSION_KHR" },
    ...
    { EGLenum::EGL_CONTEXT_OPENGL_PROFILE_MASK_KHR, "EGL_CONTEXT_OPENGL_PROFILE_MASK_KHR" },
    ...
    { EGLenum::EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY_KHR, "EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY_KHR" },
    ...
    { EGLenum::EGL_CONTEXT_RELEASE_BEHAVIOR_NONE_KHR, "EGL_CONTEXT_RELEASE_BEHAVIOR_NONE_KHR" },
    ...
    { EGLenum::EGL_DEVICE_UUID_EXT, "EGL_DEVICE_UUID_EXT" },
    ...
    { EGLenum::EGL_DRIVER_NAME_EXT, "EGL_DRIVER_NAME_EXT" },
    { EGLenum::EGL_DRIVER_UUID_EXT, "EGL_DRIVER_UUID_EXT" },
    ...
    { EGLenum::EGL_DRM_MASTER_FD_EXT, "EGL_DRM_MASTER_FD_EXT" },
    { EGLenum::EGL_DRM_PLANE_EXT, "EGL_DRM_PLANE_EXT" },
    { EGLenum::EGL_DRM_RENDER_NODE_FILE_EXT, "EGL_DRM_RENDER_NODE_FILE_EXT" },
    ...
    { EGLenum::EGL_GL_COLORSPACE_BT2020_HLG_EXT, "EGL_GL_COLORSPACE_BT2020_HLG_EXT" },
    ...
    { EGLenum::EGL_GL_COLORSPACE_DISPLAY_P3_PASSTHROUGH_EXT, "EGL_GL_COLORSPACE_DISPLAY_P3_PASSTHROUGH_EXT" },
    { EGLenum::EGL_GL_COLORSPACE_KHR, "EGL_GL_COLORSPACE_KHR" },
    { EGLenum::EGL_GL_COLORSPACE_LINEAR, "EGL_GL_COLORSPACE_LINEAR" },
    { EGLenum::EGL_GL_COLORSPACE_LINEAR_KHR, "EGL_GL_COLORSPACE_LINEAR_KHR" },
    ...
    { EGLenum::EGL_GL_COLORSPACE_SRGB, "EGL_GL_COLORSPACE_SRGB" },
    { EGLenum::EGL_GL_COLORSPACE_SRGB_KHR, "EGL_GL_COLORSPACE_SRGB_KHR" },
    { EGLenum::EGL_GL_RENDERBUFFER, "EGL_GL_RENDERBUFFER" },
    { EGLenum::EGL_GL_RENDERBUFFER_KHR, "EGL_GL_RENDERBUFFER_KHR" },
    { EGLenum::EGL_GL_TEXTURE_2D, "EGL_GL_TEXTURE_2D" },
    { EGLenum::EGL_GL_TEXTURE_2D_KHR, "EGL_GL_TEXTURE_2D_KHR" },
    { EGLenum::EGL_GL_TEXTURE_3D, "EGL_GL_TEXTURE_3D" },
    { EGLenum::EGL_GL_TEXTURE_3D_KHR, "EGL_GL_TEXTURE_3D_KHR" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X_KHR, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X_KHR" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_KHR, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_KHR" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_KHR, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_KHR" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X_KHR, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X_KHR" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y_KHR, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y_KHR" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z" },
    { EGLenum::EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z_KHR, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z_KHR" },
    { EGLenum::EGL_GL_TEXTURE_LEVEL, "EGL_GL_TEXTURE_LEVEL" },
    { EGLenum::EGL_GL_TEXTURE_LEVEL_KHR, "EGL_GL_TEXTURE_LEVEL_KHR" },
    { EGLenum::EGL_GL_TEXTURE_ZOFFSET, "EGL_GL_TEXTURE_ZOFFSET" },
    { EGLenum::EGL_GL_TEXTURE_ZOFFSET_KHR, "EGL_GL_TEXTURE_ZOFFSET_KHR" },
    ...
    { EGLenum::EGL_IMAGE_PRESERVED_KHR, "EGL_IMAGE_PRESERVED_KHR" },
    ...
    { EGLenum::EGL_LEFT_NV, "EGL_LEFT_NV" },
    ...
    { EGLenum::EGL_LOSE_CONTEXT_ON_RESET_EXT, "EGL_LOSE_CONTEXT_ON_RESET_EXT" },
    { EGLenum::EGL_LOSE_CONTEXT_ON_RESET_KHR, "EGL_LOSE_CONTEXT_ON_RESET_KHR" },
    ...
    { EGLenum::EGL_NATIVE_BUFFER_QNX, "EGL_NATIVE_BUFFER_QNX" },
    ...
    { EGLenum::EGL_NO_RESET_NOTIFICATION_EXT, "EGL_NO_RESET_NOTIFICATION_EXT" },
    { EGLenum::EGL_NO_RESET_NOTIFICATION_KHR, "EGL_NO_RESET_NOTIFICATION_KHR" },
    ...
    { EGLenum::EGL_OPENWF_DEVICE_EXT, "EGL_OPENWF_DEVICE_EXT" },
    ...
    { EGLenum::EGL_PLATFORM_SCREEN_QNX, "EGL_PLATFORM_SCREEN_QNX" },
    ...
    { EGLenum::EGL_PLATFORM_WAYLAND_KHR, "EGL_PLATFORM_WAYLAND_KHR" },
    { EGLenum::EGL_PLATFORM_X11_EXT, "EGL_PLATFORM_X11_EXT" },
    { EGLenum::EGL_PLATFORM_X11_KHR, "EGL_PLATFORM_X11_KHR" },
    { EGLenum::EGL_PLATFORM_X11_SCREEN_EXT, "EGL_PLATFORM_X11_SCREEN_EXT" },
    { EGLenum::EGL_PLATFORM_X11_SCREEN_KHR, "EGL_PLATFORM_X11_SCREEN_KHR" },
    { EGLenum::EGL_PLATFORM_XCB_EXT, "EGL_PLATFORM_XCB_EXT" },
    { EGLenum::EGL_PLATFORM_XCB_SCREEN_EXT, "EGL_PLATFORM_XCB_SCREEN_EXT" },
    { EGLenum::EGL_POST_SUB_BUFFER_SUPPORTED_NV, "EGL_POST_SUB_BUFFER_SUPPORTED_NV" },
    { EGLenum::EGL_PRESENT_OPAQUE_EXT, "EGL_PRESENT_OPAQUE_EXT" },
    { EGLenum::EGL_PRIMARY_COMPOSITOR_CONTEXT_EXT, "EGL_PRIMARY_COMPOSITOR_CONTEXT_EXT" },
    { EGLenum::EGL_PRODUCER_AUTO_ORIENTATION_NV, "EGL_PRODUCER_AUTO_ORIENTATION_NV" },
    ...
    { EGLenum::EGL_QUADRUPLE_BUFFER_NV, "EGL_QUADRUPLE_BUFFER_NV" },
    ...
    { EGLenum::EGL_RENDERER_EXT, "EGL_RENDERER_EXT" },
    { EGLenum::EGL_RGB_BUFFER, "EGL_RGB_BUFFER" },
    { EGLenum::EGL_RIGHT_NV, "EGL_RIGHT_NV" },
    ...
    { EGLenum::EGL_SIGNALED_KHR, "EGL_SIGNALED_KHR" },
    ...
    { EGLenum::EGL_STREAM_CONSUMER_IMAGE_NV, "EGL_STREAM_CONSUMER_IMAGE_NV" },
    { EGLenum::EGL_STREAM_CONSUMER_IMAGE_USE_SCANOUT_NV, "EGL_STREAM_CONSUMER_IMAGE_USE_SCANOUT_NV" },
    ...
    { EGLenum::EGL_STREAM_DMA_NV, "EGL_STREAM_DMA_NV" },
    { EGLenum::EGL_STREAM_DMA_SERVER_NV, "EGL_STREAM_DMA_SERVER_NV" },
    ...
    { EGLenum::EGL_STREAM_FRAME_MAJOR_AXIS_NV, "EGL_STREAM_FRAME_MAJOR_AXIS_NV" },
    { EGLenum::EGL_STREAM_FRAME_ORIGIN_X_NV, "EGL_STREAM_FRAME_ORIGIN_X_NV" },
    { EGLenum::EGL_STREAM_FRAME_ORIGIN_Y_NV, "EGL_STREAM_FRAME_ORIGIN_Y_NV" },
    { EGLenum::EGL_STREAM_IMAGE_ADD_NV, "EGL_STREAM_IMAGE_ADD_NV" },
    { EGLenum::EGL_STREAM_IMAGE_AVAILABLE_NV, "EGL_STREAM_IMAGE_AVAILABLE_NV" },
    { EGLenum::EGL_STREAM_IMAGE_REMOVE_NV, "EGL_STREAM_IMAGE_REMOVE_NV" },
    ...
    { EGLenum::EGL_SURFACE_COMPRESSION_EXT, "EGL_SURFACE_COMPRESSION_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_10BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_10BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_11BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_11BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_12BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_12BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_1BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_1BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_2BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_2BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_3BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_3BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_4BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_4BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_5BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_5BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_6BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_6BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_7BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_7BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_8BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_8BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_9BPC_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_9BPC_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_DEFAULT_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_DEFAULT_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_FIXED_RATE_NONE_EXT, "EGL_SURFACE_COMPRESSION_FIXED_RATE_NONE_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_PLANE1_EXT, "EGL_SURFACE_COMPRESSION_PLANE1_EXT" },
    { EGLenum::EGL_SURFACE_COMPRESSION_PLANE2_EXT, "EGL_SURFACE_COMPRESSION_PLANE2_EXT" },
    ...
    { EGLenum::EGL_SYNC_CL_EVENT_COMPLETE_KHR, "EGL_SYNC_CL_EVENT_COMPLETE_KHR" },
    { EGLenum::EGL_SYNC_CL_EVENT_KHR, "EGL_SYNC_CL_EVENT_KHR" },
    { EGLenum::EGL_SYNC_CLIENT_EXT, "EGL_SYNC_CLIENT_EXT" },
    { EGLenum::EGL_SYNC_CLIENT_SIGNAL_EXT, "EGL_SYNC_CLIENT_SIGNAL_EXT" },
    { EGLenum::EGL_SYNC_CONDITION, "EGL_SYNC_CONDITION" },
    { EGLenum::EGL_SYNC_CONDITION_KHR, "EGL_SYNC_CONDITION_KHR" },
    ...
    { EGLenum::EGL_SYNC_FENCE_KHR, "EGL_SYNC_FENCE_KHR" },
    ...
    { EGLenum::EGL_SYNC_PRIOR_COMMANDS_COMPLETE_KHR, "EGL_SYNC_PRIOR_COMMANDS_COMPLETE_KHR" },
    ...
    { EGLenum::EGL_TEXTURE_Y_U_V_WL, "EGL_TEXTURE_Y_U_V_WL" },
    { EGLenum::EGL_TEXTURE_Y_UV_WL, "EGL_TEXTURE_Y_UV_WL" },
    { EGLenum::EGL_TEXTURE_Y_XUXV_WL, "EGL_TEXTURE_Y_XUXV_WL" },
    { EGLenum::EGL_TIMEOUT_EXPIRED, "EGL_TIMEOUT_EXPIRED" },
    { EGLenum::EGL_TIMEOUT_EXPIRED_KHR, "EGL_TIMEOUT_EXPIRED_KHR" },
    { EGLenum::EGL_TIMEOUT_EXPIRED_NV, "EGL_TIMEOUT_EXPIRED_NV" },
    { EGLenum::EGL_TOP_NV, "EGL_TOP_NV" },
    ...
    { EGLenum::EGL_TRIPLE_BUFFER_NV, "EGL_TRIPLE_BUFFER_NV" },
    { EGLenum::EGL_UNSIGNALED, "EGL_UNSIGNALED" },
    { EGLenum::EGL_UNSIGNALED_KHR, "EGL_UNSIGNALED_KHR" },
    ...
    { EGLenum::EGL_VG_ALPHA_FORMAT, "EGL_VG_ALPHA_FORMAT" },
    { EGLenum::EGL_VG_ALPHA_FORMAT_NONPRE, "EGL_VG_ALPHA_FORMAT_NONPRE" },
    { EGLenum::EGL_VG_ALPHA_FORMAT_PRE, "EGL_VG_ALPHA_FORMAT_PRE" },
    { EGLenum::EGL_VG_COLORSPACE, "EGL_VG_COLORSPACE" },
    { EGLenum::EGL_VG_COLORSPACE_LINEAR, "EGL_VG_COLORSPACE_LINEAR" },
    { EGLenum::EGL_VG_COLORSPACE_sRGB, "EGL_VG_COLORSPACE_sRGB" },
    { EGLenum::EGL_VG_PARENT_IMAGE_KHR, "EGL_VG_PARENT_IMAGE_KHR" },
    { EGLenum::EGL_WAYLAND_BUFFER_WL, "EGL_WAYLAND_BUFFER_WL" },
    { EGLenum::EGL_WAYLAND_PLANE_WL, "EGL_WAYLAND_PLANE_WL" },
    { EGLenum::EGL_WAYLAND_Y_INVERTED_WL, "EGL_WAYLAND_Y_INVERTED_WL" },
    { EGLenum::EGL_WIDTH, "EGL_WIDTH" },
    { EGLenum::EGL_X_AXIS_NV, "EGL_X_AXIS_NV" },
    { EGLenum::EGL_Y_AXIS_NV, "EGL_Y_AXIS_NV" },
