...
EGLBINDING_CONSTEXPR Version::Version()
: m_major(0)
, m_minor(0)
{
}

EGLBINDING_CONSTEXPR Version::Version(unsigned char majorVersion, unsigned char minorVersion)
...
EGLBINDING_CONSTEXPR unsigned char Version::majorVersion() const
{
    return m_major;
}

EGLBINDING_CONSTEXPR unsigned char Version::minorVersion() const
{
    return m_minor;
}
...
EGLBINDING_CONSTEXPR bool Version::isNull() const
{
    return m_major == 0;
}
