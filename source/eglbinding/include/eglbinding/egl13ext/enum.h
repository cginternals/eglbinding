...
using egl::EGL_CONFIG_SELECT_GROUP_EXT;
...
using egl::EGL_DRIVER_NAME_EXT;
using egl::EGL_DRIVER_UUID_EXT;
...
using egl::EGL_DRM_RENDER_NODE_FILE_EXT;
...
using egl::EGL_GL_COLORSPACE_BT2020_HLG_EXT;
...
using egl::EGL_NATIVE_BUFFER_QNX;
...
using egl::EGL_OPENWF_DEVICE_EXT;
...
using egl::EGL_PLATFORM_SCREEN_QNX;
...
using egl::EGL_PLATFORM_XCB_EXT;
using egl::EGL_PLATFORM_XCB_SCREEN_EXT;
using egl::EGL_POST_SUB_BUFFER_SUPPORTED_NV;
using egl::EGL_PRESENT_OPAQUE_EXT;
...
using egl::EGL_STREAM_CONSUMER_IMAGE_NV;
using egl::EGL_STREAM_CONSUMER_IMAGE_USE_SCANOUT_NV;
...
using egl::EGL_STREAM_IMAGE_ADD_NV;
using egl::EGL_STREAM_IMAGE_AVAILABLE_NV;
using egl::EGL_STREAM_IMAGE_REMOVE_NV;
...
using egl::EGL_SURFACE_COMPRESSION_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_10BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_11BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_12BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_1BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_2BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_3BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_4BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_5BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_6BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_7BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_8BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_9BPC_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_DEFAULT_EXT;
using egl::EGL_SURFACE_COMPRESSION_FIXED_RATE_NONE_EXT;
using egl::EGL_SURFACE_COMPRESSION_PLANE1_EXT;
using egl::EGL_SURFACE_COMPRESSION_PLANE2_EXT;
