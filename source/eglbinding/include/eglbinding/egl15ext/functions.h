...
using egl::eglQueryDeviceBinaryEXT;
...
using egl::eglQueryStreamConsumerEventNV;
...
using egl::eglQuerySupportedCompressionRatesEXT;
...
using egl::eglStreamAcquireImageNV;
...
using egl::eglStreamImageConsumerConnectNV;
using egl::eglStreamReleaseImageNV;
