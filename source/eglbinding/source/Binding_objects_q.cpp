...
Function<EGLBoolean, EGLDeviceEXT, EGLint, EGLint, void *, EGLint *> Binding::QueryDeviceBinaryEXT("eglQueryDeviceBinaryEXT");
...
Function<EGLint, EGLDisplay, EGLStreamKHR, EGLTime, EGLenum *, EGLAttrib *> Binding::QueryStreamConsumerEventNV("eglQueryStreamConsumerEventNV");
...
Function<EGLBoolean, EGLDisplay, EGLConfig, const EGLAttrib *, EGLint *, EGLint, EGLint *> Binding::QuerySupportedCompressionRatesEXT("eglQuerySupportedCompressionRatesEXT");
